...
> = ({
  ...
  return (
    <div
      className="rounded-81xl bg-negative-background-light overflow-hidden flex flex-row items-center justify-center py-1 px-2 text-center text-2xs text-text-negative font-caption-s border-[1px] border-solid border-negative-muted"
